...
(function(window){
  ...
  async function query_model(patientName) {
    ...
    if(patientName == "NANCY"){
      ...
      displaySummary([{generated_text: "The patient is a 42-year-old male with a history of morbid obesity, OSA, hypertension, and psoriasis who presented with shortness of breath and decreased level of consciousness due to hypercapnic respiratory failure. He was initially admitted to the ICU and treated for community-acquired pneumonia with ceftriaxone and azithromycin from December 13 to 19. On December 23, he was diagnosed with bilateral pulmonary emboli and started on anticoagulation. He had a tracheostomy on January 1 and was transferred to the medical floor on January 17. He also had distal lower extremity weakness, seen by neurology.\n\nThe patient's current issues include:\n\n* Hypercapnic respiratory failure\n* Pulmonary emboli\n* Distal lower extremity weakness\n\nThe patient's assessment and plan include:\n\n* Encourage use of CPAP\n* Continue therapeutic dalteparin\n* Likely critical illness neuropathy\n* Left foot pressure injury\n* DVT prophylaxis: On dalteparin\n* Diet: On NG tube feeds plus puréed diet\n* CODE STATUS: Full Disposition: Pending improvement\n\nThe patient's progress notes for January 19, 2024, at 23:03, indicate that the patient feels well, has comfortable respirations, and has no asterixis or confusion. His sensation is normal in the lower extremities, and he has no pressure injury. His lab results show normal sodium and potassium levels, but his chloride level is low. His TSH level is high, and his liver function tests show normal bilirubin and ALP levels. His B12 level is normal.\n\nThe patient's current issues and assessment and plan are unchanged from the previous day. The patient is stable and does not require any changes to his treatment plan at this time. The patient's progress will be reassessed tomorrow, and any necessary changes to his treatment plan will be made based on his condition at that"}]);
      return
    }else{
      ...
      displaySummary([{generated_text: "The patient is a 69-year-old female who was admitted to the hospital on January 14, 2024, with a diagnosis of confusion and new-onset altered mental status. The patient was seen by a neurologist on January 16, 2024, and an MRI of the brain was ordered. The patient was found to have mild global cerebral atrophy, with a score of 2 on the Global Cortical Atrophy Scale (GCAG). The patient was also found to have mild vascular disease, with no acute infarcts or microbleeds. The patient was placed on form 3 and discharged home with a sitter."}]);
      return
    }
