(function(window){
  ...
  function displaySummary(result) {
    ...
    textarea.value = generatedText; // Set the generated summary as the value
  
    // Dynamically adjust the textarea height to fit the content
    textarea.style.resize = 'none'; // Optional: prevent manual resizing
    textarea.style.height = 'auto'; // Initially set height to auto to reset any previous height
    textarea.style.height = textarea.scrollHeight + 'px'; // Adjust height based on scroll height
  
    // Append the textarea to the summary element
    summaryElement.appendChild(textarea);
  
    // Adjust the textarea height dynamically on input changes
